		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "import",
									"targetURL": "#ui5colimportcsv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5colimportcsv-display": {
								"semanticObject": "ui5colimportcsv",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.col.importcsv",
									"url": sap.ui.require.toUrl("ui5/col/importcsv")
								}
							}
						}
					}
