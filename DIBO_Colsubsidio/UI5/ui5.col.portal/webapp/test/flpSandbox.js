		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "portal",
									"targetURL": "#ui5colportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5colportal-display": {
								"semanticObject": "ui5colportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.col.portal",
									"url": sap.ui.require.toUrl("ui5/col/portal")
								}
							}
						}
					}
